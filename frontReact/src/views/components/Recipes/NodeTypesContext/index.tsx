...
import StandardNode from '../RecipeNode';
...
export const RecipeTypesProvider: FC<RecipeTypesProviderProps> = ({ children }) => {
  ...
  const addRecipeType = (key: string, component: NodeTypeComponent = StandardNode) => {
  ...
  const addRecipeTypeIfNeeded = (key: string, component: NodeTypeComponent = StandardNode) => {
    setNodeTypes((prevNodeTypes) => {
